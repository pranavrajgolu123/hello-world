...
public class CreateGrpPermissionPop  extends CommonPopUp
{
	...
	public CreateGrpPermissionPop ( UIComponentsUtil uiComponentsUtil)
	{
		super("Create Group Permissions", "", "Submit", true );
	...
	private void buttonAction()
	{
		addButtonClickCommand( new Icommand()
		{
			...
			public void execute()
			{
				...
				LoggerUtil.log( "Create Active Directory" );
