...
public class VMCreateAttachLemModel implements Serializable
{
	/**
	 * 
	 */
	...
	private LEMJSONModel[] lems;

	private NameModel[] networks;
	
	private String[] cdroms;

	public VMCreateAttachLemModel()
	{
		super();
	}

	public VMCreateAttachLemModel( long vcpu, String name, long memory, String memory_unit, String graphic_port, LEMJSONModel[] lems, NameModel[] networks, String[] cdroms )
	{
		super();
		this.vcpu = vcpu;
		this.name = name;
	...
	public LEMJSONModel[] getLems()
	{
		return lems;
	}

	public void setLems( LEMJSONModel[] lems )
	{
		this.lems = lems;
	}
