...
public class VMCreateCloneLemModel implements Serializable
{
	/**
	 * 
	 */
	...
	private CloneLEMModel[] clone_lem;
	
	private NameModel[] networks;
	
	private String[] cdroms;

	public VMCreateCloneLemModel()
	{
		super();
	}

	public VMCreateCloneLemModel( long vcpu, String name, long memory, String memory_unit, String graphic_port, CloneLEMModel[] clone_lem, NameModel[] networks, String[] cdroms )
	{
		super();
		this.vcpu = vcpu;
		this.name = name;
	...
	public CloneLEMModel[] getClone_lem()
	{
		return clone_lem;
	}

	public void setClone_lem( CloneLEMModel[] clone_lem )
	{
		this.clone_lem = clone_lem;
	}
}
