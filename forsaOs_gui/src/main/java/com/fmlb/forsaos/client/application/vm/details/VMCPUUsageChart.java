...
public class VMCPUUsageChart
{

	public static native JavaScriptObject drawVMCPUUsageChart( String id )
	/*-{
		var chart = $wnd.AmCharts.makeChart(id, {
			...
			"panels" : [ {
				...
				"stockGraphs" : [ {
					...
					"valueField" : "cpu_percent",
					"balloonFunction" : function(item) {
						return "Used: <b>" + item.values.value + "%" + "</b>";
					}
				} ],
				"stockLegend" : {
					"position" : "bottom",
