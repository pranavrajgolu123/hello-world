...
public class VMCreateWithNewLemModel implements Serializable
{
	/**
	 * 
	 */
	...
	public VMCreateWithNewLemModel()
	{
		super();
	}

	public VMCreateWithNewLemModel( long vcpu, String name, long memory, String memory_unit, String graphic_port, LEMJSONModel[] create_lem, NameModel[] networks, String[] cdroms )
	{
		super();
		this.vcpu = vcpu;
		this.name = name;
